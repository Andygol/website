...
## Використовуючи цей репозиторій
...
Для збирання вебсайти з використанням контейнера, зробіть наступне:
...
Крім того, зверніть увагу, що у вас може бути більше одного рецензента Kubernetes, який надасть вам відгук, або ви можете отримати зворотний звʼязок від рецензента Kubernetes, який відрізняється від того, який спочатку був призначений для надання вам відгуків.
